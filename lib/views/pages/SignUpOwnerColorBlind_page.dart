...
class SignUpStoreOwnerColorBlindPage extends StatefulWidget {
  ...
  @override
  State<SignUpStoreOwnerColorBlindPage> createState() => _SignUpStoreOwnerColorBlindPageState();
}

class _SignUpStoreOwnerColorBlindPageState extends State<SignUpStoreOwnerColorBlindPage> {
  String errorMessage = '';
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Sign up as Store Owner ColorBlind(${widget.plan}) (${colorBlindType ?? 'Normal Vision'})",
                              style: const TextStyle(
                                fontSize: 16,
                                color: Colors.grey,
                              ),

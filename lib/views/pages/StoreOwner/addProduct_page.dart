...
class _AddVariantBottomSheetState extends State<AddVariantBottomSheet> {
  ...
  List<String> values = [""]; // Always starts with one input field
                            ...
                            child: TextField(
                              ...
                              onChanged: (text) {
                                ...
                                setState(() {
                                  ...
                                  //  Ensure the last field is always empty for adding new values
                                  if (text.isNotEmpty &&
                                      index == values.length - 1) {
                                    print("Adding new empty text field...");
                                    values = [
                                      ...values,
                                      ""
                                    ]; //  Fix: Creates a completely new list
                                  }

                                  print("Updated values: $values");
                                  print("now values.length: ${values.length}");
                                });
                              },
                            ),
                          ),
